...
if (window.adsInI!=1){
adsInI=1
var adsUK=1,adsIntl=1,adsHt="http://uk.at.atwola.com",adsNt='1065.1',adsPl='2590140',adsESN='',adsATWM='',adsTp='J',
adsATOth='',adsSrAT='',adsTacOK=1,adsD=new Date(),aolAdFdBkStr='',adsAddOn=1,
adsScr=adsD.getTime()%0x3b9aca00,adsTar='_blank',adsVal='',adsCp=0,adsMNS,adsExcV='',adsLNm=0,
tcodeSrc='http://cdn.at.atwola.com/_media/uac/tcodewads_at.html',tcodeSrc2='http://cdn.at.atwola.com/_media/uac/eutcode.html',
adsNv=navigator,adsOld=1,adsSaf,adsFF1,adsSaf3,adsUA=adsNv.userAgent.toLowerCase(),adsIE,adsIpad,
adsAJAX=0,adsTzAT="aduho="+(-1*adsD.getTimezoneOffset())+";",
adsNMSG='',adsTile=1,adsPage='',adsDivs=[],adsQuigo=0,adsCA,adsCF=[],adsCW=[],adsCH=[],adsCAd=[],adsAlias=1;
var adsLMN=new Array(),adsAH1="<a href='",adsI1="<img src=",adsI3=" border=0 alt=\"Advertisement\"></A>";
...
var an=adsNv.appName,av=adsNv.appVersion,ns=(an=="Netscape"),op=(adsUA.indexOf("opera")!=-1),at=adsLo.indexOf('atwCrPr='),
n6=(adsUA.indexOf('netscape6')!=-1),n7=(adsUA.indexOf('netscape/7')!=-1),n8=(adsUA.indexOf('netscape/8')!=-1),
min='',mac=(adsUA.indexOf("mac")!=-1),ie6=0,iep=av.indexOf('MSIE');
adsIE=(an=="Microsoft Internet Explorer");
adsFF1=(adsUA.indexOf("firefox/1.0")!=-1);
adsSaf=(adsUA.indexOf('safari')!=-1);
adsSaf3=0;
adsIpad=(adsUA.indexOf('ipad')!=-1);
if (iep!=-1)min=parseFloat(av.substring(iep+5,av.indexOf(';',iep)))
if (iep&&!mac&&(parseInt(min)>=6))ie6=1
if (adsSaf&&adsUA.indexOf('win')!=-1){
var v=adsUA.indexOf('version');
if (adsUA.substring(v+8,v+9)>2||adsUA.indexOf('chrome')>0)adsSaf3=1
}
if ((ie6||(ns&&parseInt(av)>=5))&&!op&&!n6&&!n7&&!n8&&!adsFF1)adsOld=0
...
if (v&&!((v.charAt(v.length-1)=='=')||((v.charAt(v.length-1)==';')&&(v.charAt(v.length-2)=='=')))){
...
if (s){
if (m&&adsUK)s=s.replace(/alias=[0-9]*;/,"alias="+m+";").replace(/kvmn=[0-9]*;/,"kvmn="+m+";");
var i=s.indexOf(';grp='),j=s.indexOf(';misc='),u=''
if (i==-1&&j==-1)u=s.replace(/ /, "")+" ";
else u=s.substring(0,i+5)+dt+s.substring(j,j+6)+dt
v.adURL=u
if (s.indexOf('/adlink/')!=-1){
s=v.adPage
i=s.indexOf(';grp=')
j=s.indexOf(';misc=')
dt=adsD.getTime()%0x3b9aca00
u=s.substring(0,i+5)+dt+s.substring(j,j+6)+dt
v.adPage=u
}
v.LoadAd()
}}
...
try {f=document.getElementById(nm1)}
catch (e){}
if (f){
if (v!='all')adsD=new Date()
try {s=f.src}
...
if (s){
if (m&&adsUK) s=s.replace(/alias=[0-9]*;/,"alias="+m+";").replace(/kvmn=[0-9]*;/,"kvmn="+m+";")
var dt=adsD.getTime()%0x3b9aca00,i=s.indexOf(';grp='),j=s.indexOf(';misc=');
try {f.src=s.substring(0,i+5)+dt+s.substring(j,j+6)+dt;r=true}
catch(e){}}}
return r
}
function adsReloadIframeAll(){
var n,r=false,f='',l=adsLMN.length
adsD=new Date()
for (var i=0;i<l;i++){
n=adsLMN[i].split('|')
try {f=document.getElementById(n[0])}
catch (e){break}
if (f){adsReloadIframe(n[0],'','all');r=true}
}
return r
}
function adSetExt(){}
function adSetNoAlias(){if (!adsUK)adsAlias=0}
function adSetAlias(v){if (!adsUK)adsAlias=v}
...
if (adsQuigo==0&&(/aolSize=["']([\d]*?)\|([\d]*)["']/i.test(aD1))){
...
var v=unescape(adsLo).match(/\?icid=.*?[|](.*?)[|](.*?)[|](.*?)[|]/),r='',p='',x=0;
if (v){
for (var i=1;i<=3;i++){
...
var exDom=new Array("www.aim.com","www.aol.co.uk","webmail.aol.com","ads.web.aol.com");
...
var d=document,inc='',s,r=0,st="<script type='text/javascript' src='",imgOnly,htmlOnly,sp1,ye=0,c=0;
if (t){
t=t.toLowerCase()
...
if (w==300&&(h==250||h==600||h==1050)){
imgOnly='artexc=all;artinc=art_rrimage,art_rrimg1x1,art_rr3pimg,art_rrtext;'
htmlOnly='artexc=all;artinc=art_rrimage,art_rrimg1x1,art_rr3pimg,art_rrtext,art_rrhtml;'
}
else {
imgOnly='artexc=all;artinc=art_image,art_img1x1,art_3pimg,art_text;'
htmlOnly='artexc=all;artinc=art_image,art_img1x1,art_3pimg,art_text,art_html;'
}
if (adsUK&&adsOld){
adsOld=0
if (t!='text')inc=imgOnly
}
if (adsUK&&adsSaf&&adsUA.indexOf("win")!=-1&&!adsSaf3){
if(t!='text')inc=imgOnly
else {adsTp='J';t=''}
}
if (t=='text'||t=='ajax'||t=='f'||adsTp=='F'){
if (!fn||fn=='')fn=adsPage
if (fn==''){adsTp='J';t=''}
}
if (w=='LB'||w=='lb'){
w=728,h=90;
if (adsTp=='F'||t=='ajax'||t=='f')ds='r'
sz='728x90,948x250,970x66,970x90';
}
if (adsCp){
var cl=adsCF.length;
for (var i=0;i<cl;i++){
...
if (r==0){
if (t!='text'&&!adsOld&&!inc){
if (!adsNMSG)adsCkPlg()
if (!adsNMSG){
if (adsUK){
if (adsIpad)inc=htmlOnly 
else inc=imgOnly
}
else adsOld=1
}}
if (window.ATMap&&ATMap[m]!=null)m=ATMap[m]
if (!adsAlias)adsPl=m
s=adsHt+"/addyn/3.0/"+adsNt+"/"+adsPl+"/0/-1/"
if (sz)s+="allowedSizes="+sz+";"
else if (ds!='r')s+="size="+w+"x"+h+";"
s+="noperf=1;"
if (adsAlias)s+="alias="+m+";";
if (adsTile!=1)s+="cfp=1;";
if (inc!=''||t=='ajax'||adsAddOn==2){
s+="noaddonpl=y;";
adsAddOn=2;
}else{
 if (adsTile==1){
...
if (adsUK&&!adsOld)s+=inc
s+=adsATOth+adsSrAT+adsATWM+adsVal+"kvmn="+m+";target="+adsTar+";"+adsTzAT+"grp="+adsScr+";misc="+adsScr
var sImg = s.replace(/addyn/,"adserv")
var sHref = s.replace(/addyn/,"adlink")
}
if (!adsOld){
if (t=='text'){
...
if (t!='ajax'){
d.write(adsAH1+sHref+"' target="+adsTar+">"+adsI1+"'"+sImg+"' width="+w+" height="+h+adsI3)
}
else{
adSetupDiv(w,h,sHref,dv,sImg,ds,m)
adsDivs[adsDivs.length-1].LoadAd()
}}
adsTile++
}
...
if (!adsVal)adsVal=adsGetValues()
if (!adsAlias)adsPl=m
s=adsHt+"/adserv/3.0/"+adsNt+"/"+adsPl+"/0/-1/size="+w+"x"+h+";noperf=1;"
if (adsAlias)s+="alias="+m+";"
if (adsTile!=1)s+="cfp=1;"
s+=adsATOth+adsVal+"kvmn="+m+";target="+adsTar+";"+adsTzAT+"noaddonpl=y;grp="+adsScr+";misc="+adsScr
